...
База данных заполняется 15 тестовыми пользователями в 4 отделах для удобного тестирования функционала.
PR приветствуются! Для существенных изменений сначала откройте issue для обсуждения.

---

**Made with ❤️ using React Native, Express & Prisma**
